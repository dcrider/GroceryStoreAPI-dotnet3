...
{
    /*
        Leftover code from first implementation. Originally went with a dictionary as a datasource (for hash speed) and had
        a slightly less robust structure (no service layer). Abandoned once I started writing the unit tests in favor of a 
        looser and more easily testable repo pattern. 
    */
